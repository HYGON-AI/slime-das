...
def add_convertion_args(parser):
    ...
    parser.add_argument(
        ...
        # Qwen3.5 / Qwen3-Next args. Some Megatron versions do not register them.
    try:
    ...
    try:
        parser.add_argument("--attention-output-gate", action="store_true")
    except Exception:
        pass
...
def main():
    ...
    if hasattr(torch.version, "hip") and torch.version.hip is not None:
        assert args.use_cpu_initialization, "HCU GPU requires --use_cpu_initialization=True"
